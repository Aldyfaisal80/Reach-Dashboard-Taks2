                      ...
                      <div className="shadow w-full rounded-lg bg-white overflow-hidden w-full block p-8">
                        ...
                        <div className="inline-block w-64 mb-4">
                          ...
                          <div className="relative">
                            <select value={eventTheme} onChange={(e) => setEventTheme(e.target.value)} className="block appearance-none w-full bg-gray-200 border-2 border-gray-200 hover:border-gray-500 px-4 py-2 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-blue-500 text-gray-700">
